...
label_00 = M5Label('00:00', x=0, y=188, color=0xffffff, font=FONT_MONT_12)
label_06 = M5Label('06:00', x=72, y=188, color=0xffffff, font=FONT_MONT_12)
label_12 = M5Label('12:00', x=144, y=188, color=0xffffff, font=FONT_MONT_12)
label_18 = M5Label('18:00', x=216, y=188, color=0xffffff, font=FONT_MONT_12)
label_24 = M5Label('24:00', x=286, y=188, color=0xffffff, font=FONT_MONT_12)
